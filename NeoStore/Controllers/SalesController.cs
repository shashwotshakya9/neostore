...
namespace NeoStore.Controllers
{
    public class SalesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,SaleDate,BillNumber,CustomerId")] Sale sale)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,SaleDate,BillNumber,CustomerId")] Sale sale)
        {
            if (id != sale.Id)
            {
                return NotFound();
